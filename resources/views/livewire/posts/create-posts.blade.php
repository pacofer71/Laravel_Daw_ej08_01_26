            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" placeholder="Escribe el título del post"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea rows="5" placeholder="Escribe el contenido del post"
                ...
                <div>
                    ...
                    <div class="flex gap-6">
                        ...
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="estado" class="text-blue-600 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <div class="w-full h-80 bg-gray-200 relative rounded-lg">
                        <input type="file" id="cimagen" class="hidden" accept="image/*" />
