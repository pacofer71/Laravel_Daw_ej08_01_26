    ...
    <x-dialog-modal wire:model="openCrear">
        ...
        <x-slot name="content">
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input id="name" type="text" placeholder="Ej: Tecnología"
        ...
        <x-slot name="footer">
            <div class="flex flex-row-reverse">
                <button class="text-white p-2 rounded-xl font-bold bg-green-500 hover:bg-green-700">
                    <i class="fas fa-save mr-1"></i>GUARDAR
                </button>
                <button class="mr-2 text-white p-2 rounded-xl font-bold bg-red-500 hover:bg-red-700">
